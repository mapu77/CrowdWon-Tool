...
function buildCell(imgSelected) {
  ...
  } else if (imgSelected === "img/generation.svg") {
    return new joint.shapes.basic.Generator();
  } else if (imgSelected === "img/aggregation.svg") {
    return new joint.shapes.basic.Aggregation();
  } else if (imgSelected === "img/map-reduce.svg") {
    return new joint.shapes.basic.MapReduce();
...
function showAlert(boldMessage, message) {
  $('<div id="floating_alert" class="alert alert-danger fade in">' +
...
$('#validate').click(function () {
  showAlert("Invalid diagram", "There's something wrong");
});
